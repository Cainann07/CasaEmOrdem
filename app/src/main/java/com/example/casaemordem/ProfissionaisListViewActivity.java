...
public class ProfissionaisListViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int[] produtosList = {R.string.pedroAlvesPrudutos, R.string.mariaLuizaProdutos,R.string.matheusProdutos,R.string.ericGomesProdutos,R.string.warlisonProdutos, R.string.brunoVieiraProdutos, R.string.DavidProdutos};
        ...
        String[] tipoMatList = {"Mat. Class A", "Mat. Class A", "Mat. Class B","Mat. Class C", "Mat. Class B", "Mat. Class B", "Mat. Class C"};
        for (int i = 0; i < imageList.length; i++){
            listData = new ListData(nameList[i], tipoMatList[i], produtosList[i], descList[i], imageList[i]);
        ...
        binding.listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                intent.putExtra("time", tipoMatList[i]);
                intent.putExtra("ingredients", produtosList[i]);
