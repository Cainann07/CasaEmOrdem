...
public class MeusServicosAgendadosProfissionalActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_meus_servicos_agendados_profissional);
    ...
    public void HistoricoProfissional(View view){
